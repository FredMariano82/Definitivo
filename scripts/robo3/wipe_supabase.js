...
(async () => {
    ...
    const res1 = await supabase.from('prestadores').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    if (res1.error) console.error(res1.error);

    console.log('Apagando todas as solicitações...');
    const res2 = await supabase.from('solicitacoes').delete().neq('id', '00000000-0000-0000-0000-000000000000');
