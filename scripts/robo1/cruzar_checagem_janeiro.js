...
const SOURCE_FILE = path.join(DIR, "checagens JAN 2026.xlsx");
...
async function mergeJanuary() {
    console.log("🚀 Iniciando cruzamento de checagem (JANEIRO)...");
    ...
    console.log("📡 Lendo base de checagens de Janeiro...");
    ...
    // 3. Salvar
    console.log(`\n📊 Resultado:`);
    console.log(`   🔹 Registros atualizados no mestre com dados de Janeiro: ${updates}`);
    ...
    try {
        ...
        console.log(`\n✨ SUCESSO! Arquivo mestre atualizado com dados de Janeiro.`);
    } catch (e) {
        if (e.code === 'EBUSY') {
...
mergeJanuary().catch(e => console.error("❌ Erro fatal:", e));
