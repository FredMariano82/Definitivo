...
const SOURCE_FILE = path.join(DIR, "checagens DEZ 2025.xlsx");
...
async function mergeDecember() {
    console.log("🚀 Iniciando cruzamento de checagem (DEZEMBRO)...");
    ...
    console.log("📡 Lendo base de checagens de Dezembro...");
    ...
    dataSource.forEach(row => {
        // Colunas identificadas: NOME, EMPRESA
        const nome = row['NOME'];
    ...
    // 3. Salvar
    console.log(`\n📊 Resultado:`);
    console.log(`   🔹 Registros atualizados no mestre com dados de Dezembro: ${updates}`);
    ...
    try {
        ...
        console.log(`\n✨ SUCESSO! Arquivo mestre atualizado com dados de Dezembro.`);
    } catch (e) {
        if (e.code === 'EBUSY') {
...
mergeDecember().catch(e => console.error("❌ Erro fatal:", e));
